...
const sidebars = {
  textbookSidebar: [
    ...
    },
    {
      ...
      label: 'Part II: Core Technologies',
      items: [
        'ch03-ros2-architecture/index',
        'ch04-gazebo-simulation/index',
        'ch05-isaac-platform/index',
        'ch06-urdf-xacro/index'
      ]
    },
    {
      type: 'category',
      label: 'Part III: Perception and Control',
      items: [
        'ch07-perception-systems/index',
        'ch08-navigation/index',
        'ch09-manipulation/index'
      ]
    },
    {
      type: 'category',
      label: 'Part IV: Advanced Topics',
      items: [
        'ch10-vla-models/index',
        'ch11-humanoid-design/index',
        'ch12-learning-adaptation/index',
        'ch13-multi-robot-systems/index',
        'ch14-safety-ethics/index'
      ]
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      label: 'Appendices',
      items: [
        'appendices/appendix-a-installation',
        'appendices/appendix-b-setup',
        'appendices/appendix-c-troubleshooting',
        'appendices/appendix-e-code-templates',
        'appendices/appendix-g-resources'
      ]
    }
  ]
};
